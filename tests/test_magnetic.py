...
class TestMagnetic:
    ...
    def _run_test(self, mas_filename: str, validate_geometry: bool = False):
        ...
        builder = Builder()
        step_path, stl_path = builder.get_magnetic(magnetic_data, output_name, output_path=self.output_path, export_files=True)
...
class TestToroidal(TestMagnetic):
    ...
    def test_toroidal_single_turn_with_core(self):
        ...
        step_path, stl_path, solid_info = self._run_test("toroidal_one_turn.json", validate_geometry=True)
    ...
    def test_toroidal_two_turns_spread(self):
        ...
        step_path, stl_path, solid_info = self._run_test("toroidal_two_turns_spread.json", validate_geometry=True)
    ...
    def test_toroidal_two_turns_centered(self):
        ...
        step_path, stl_path, solid_info = self._run_test("toroidal_two_turns_centered.json", validate_geometry=True)
    ...
    def test_toroidal_full_layer(self):
        ...
        step_path, stl_path, solid_info = self._run_test("toroidal_full_layer.json", validate_geometry=True)
...
class TestFullMagnetic(TestMagnetic):
    ...
    def test_etd49_round_wire_6_turns(self):
        ...
        step_path, stl_path, solid_info = self._run_test("ETD49_N87_10uH_5T.json", validate_geometry=True)
    ...
    def test_pq4040_foil_wire_6_turns(self):
        ...
        step_path, stl_path, solid_info = self._run_test("PQ4040_10u_6T_foil.json", validate_geometry=True)
